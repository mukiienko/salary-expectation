...
const Salary = () => {
  ...
  useEffect(() => {
    const salaryInstanceNew = SalaryBuilder.createSalaryFromProfile(profile.data);
          ...
          <div className={css.container__inner}>
            ...
            <article className={css.container__content}>
              <div className={css.container__headline}>
                ...
                <Select label="Period" list={periodFilterConfig} value={period} handleChange={changePeriod} />
              </div>
